...
export function Logo(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden {...props}>
      <path d="M12 2 20 7v10l-8 5-8-5V7l8-5Zm0 3.4L6.6 8.7v6.6L12 18.6l5.4-3.3V8.7L12 5.4Z" opacity="0.25" />
      <path d="M12 2 20 7v10l-8 5-8-5V7l8-5Zm-1.2 5.6v7L15.2 12l-4.4-.6Z" />
    </svg>
  );
}
...
export function LayersIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="m3 12 9 4.9 9-4.9M3 16.5 12 21.4l9-4.9" />
    </svg>
  );
}
...
export function ServersIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M6.5 6.5h.01M6.5 17.5h.01M9.5 6.5h.01M9.5 17.5h.01" />
    </svg>
  );
}
...
export function FlaskIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M10 2v6L4.8 18a2 2 0 0 0 1.8 3h10.8a2 2 0 0 0 1.8-3L14 8V2" />
      <path d="M7.5 15h9" />
    </svg>
  );
}
...
export function FlagIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M5 22V4a1 1 0 0 1 1-1h12l-3 4 3 4H6" />
    </svg>
  );
}
